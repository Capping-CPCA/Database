...
$result = pg_query_params($con,
  'SELECT addAgencyReferral(
          ...
          dob :=  $4::DATE,
          houseNum := $7::INTEGER,
          streetAddress := $8::TEXT,
          apartmentInfo := $9::TEXT,
          zipCode := $10::INTEGER,
          city := $11::TEXT,
          state := $12::STATES,
          referralReason := $13::TEXT,
          hasAgencyConsentForm := $14::BOOLEAN,
          referringAgency := $15::TEXT,
          referringAgencyDate := $16::DATE,
          additionalInfo := $17::TEXT,
          hasSpecialNeeds :=$18::BOOLEAN,
          hasSubstanceAbuseHistory :=$19::BOOLEAN,
          hasInvolvementCPS :=$20::BOOLEAN,
          isPregnant :=$21::BOOLEAN,
          hasIQDoc := $22::BOOLEAN,
          mentalHealthIssue := $23::BOOLEAN,
          hasDomesticViolenceHistory := $24::BOOLEAN,
          childrenLiveWithIndividual := $25::BOOLEAN,
          dateFirstContact := $26::DATE,
          meansOfContact := $27::TEXT,
          dateOfInitialMeeting := $28::DATE,
          location := $29::TEXT,
          comments := $30::TEXT,
          eID := $31::INTEGER)',
              array(
